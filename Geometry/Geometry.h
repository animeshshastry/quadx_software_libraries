...
public:
    ...
    Rotation &FromQuaternions(float qw, float qx, float qy, float qz);
    Rotation &FromOrthoVectors(Point x, Point y, Point z);
    Rotation &FromStereo(Matrix<2,1> s, float psi);
